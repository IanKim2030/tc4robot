...
| [docs/callflow/README.md](docs/callflow/README.md) | **업무 코드별 콜플로우 인덱스** — 알림 경로 규칙(BSUBS/SDM), 12개 코드 |
| [docs/callflow/CDS_&lt;코드&gt;.md](docs/callflow/README.md) | 업무 코드별 시트 — 콜플로우·Body 필드·판정 기준 (A1 1X 1Y I2 I3 C1 G1 K1 K2 K3 D3 Z1) |
