...
TC-NWDAF PGW 최소 Notification (Smoke)
    [Documentation]
...
TC-NWDAF eNB 최소 Notification (Smoke)
    [Documentation]
...
TC-NWDAF PGW QUICK_SUPPORT 즉시 (0)
...
TC-NWDAF PGW QUICK_SUPPORT Update 후 (1)
...
TC-NWDAF eNB SUPPORT_TYPE 제어 (1)
...
TC-NWDAF eNB SUPPORT_TYPE 해지 (2)
...
TC-NWDAF COMMON1 RCT Usage 경계 0
...
TC-NWDAF COMMON1 RCT Usage 경계 최대 (9,999,999)
...
TC-NWDAF COMMON2 NETWORK WCDMA (1)
    [Tags]    nwdaf    nwdaf_common2    nwdaf_network
    ${c1}=    Build COMMON1    ${NWDAF_PCEF_PGW}
    ${qc}=    Build pcefQoSCtrl
...
TC-NWDAF COMMON2 NETWORK LTE (2)
    [Tags]    nwdaf    nwdaf_common2    nwdaf_network
    ${c1}=    Build COMMON1    ${NWDAF_PCEF_PGW}
    ${qc}=    Build pcefQoSCtrl
...
TC-NWDAF COMMON2 CONTROL_UNIT Cell (1)
...
TC-NWDAF COMMON2 CONTROL_UNIT eNodeB (2)
    [Tags]    nwdaf    nwdaf_common2    nwdaf_cu
    ${c1}=    Build COMMON1    ${NWDAF_PCEF_PGW}
    ${qc}=    Build pcefQoSCtrl
...
TC-NWDAF COMMON2 DN_USAGE 경계값 0
...
TC-NWDAF COMMON2 DN_USAGE 경계 최대 (9,999,999)
    [Tags]    nwdaf    nwdaf_common2    nwdaf_usage
    ${c1}=    Build COMMON1    ${NWDAF_PCEF_PGW}
    ${qc}=    Build pcefQoSCtrl
...
TC-NWDAF COMMON2 USER_RATIO Disable (1)
...
TC-NWDAF Body inner 순서 = COMMON1 + pcefQoSCtrl + COMMON2
    [Documentation]
...
TC-NWDAF Negative — Unknown NETWORK Value (0x04)
    [Documentation]
...
TC-NWDAF Negative — Unknown PCEF_TYPE (0x02)
    [Documentation]
