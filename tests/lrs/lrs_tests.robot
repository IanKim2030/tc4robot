...
# ════════════════════════════════════════════════════════════════
# 0x03/0x04  Ping
# (Hello는 Suite Setup에서 처리 완료)
# ════════════════════════════════════════════════════════════════

TC-LRS-001 Ping - SYS_ID / BRANCH_NAME 수신 및 정상 응답
    [Documentation]
...
TC-LRS-003 Ping - 연속 3회 TXN ID 순차 에코
...
TC-LRS-004 Location-Info - LTE 정상 조회 및 응답 (RESULT_CODE=0)
    [Documentation]
    ...    규격서 3.2.6 / 3.2.7 / 4.2
...
TC-LRS-005 Location-Info - 5G 정상 조회 및 응답 (SBI, SERVICE_ID 없음)
    [Documentation]
...
TC-LRS-006 Location-Info - TXN ID 에코 검증
...
TC-LRS-007 Location-Info - TID 에코 검증
...
TC-LRS-008 Location-Info - 응답 필드 검증 (CELL_INFO, TA_CODE, NET_TP)
    [Documentation]
...
TC-LRS-009 Location-Info - 세션 Not Found 응답 (RESULT_CODE=200)
    [Documentation]
...
TC-LRS-010 Location-Info - PGW RAA Timeout 응답 (RESULT_CODE=300)
    [Documentation]
...
TC-LRS-011 Location-Info - Failover 응답 (RESULT_CODE=9999)
    [Documentation]
